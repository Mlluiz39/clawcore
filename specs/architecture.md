# Arquitetura do Projeto: MlluizDevClaw
...
| Padronização de LLMs | Não-funcional | Alta | Troca dinâmica de provedores (Gemini, DeepSeek, Groq, Cerebras). |
...
```mermaid
graph TB
    User([👤 Usuário MlluizDev])
    Telegram[📱 Telegram Client]
    System[🏗️ MlluizDevClaw Engine]
    LLM[🧠 LLM APIs - Gemini/DeepSeek/Groq/Cerebras]
